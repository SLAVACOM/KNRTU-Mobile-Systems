...
import com.example.knrtu_mobile_systems.data.Datasource
import com.example.knrtu_mobile_systems.model.Topic
...
@Composable
fun TopicApp(modifier: Modifier) {
    TopicList(Datasource().topics, modifier)
}
